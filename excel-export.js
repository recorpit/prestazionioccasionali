...
console.log('excel-export.js caricato - Solo export per mese con selezione:', {
...
console.log('✅ excel-export.js caricato - Export per mese con selezione e modifiche commercialista implementato');
